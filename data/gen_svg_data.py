...
class SVGGenerator():
    ...
    def gen_svg(self, in_data=None):
        ...
        if in_data == None:
            ...
            parameters['length_min'] = 10 
            parameters['length_max'] = 120 
            parameters['svg_height'] = 500
            parameters['svg_width'] = 500 
            parameters['s_width_min'] = 1
            parameters['s_width_max'] = 2
            element_data, label_data = self.gen_svg_element_data(element_arr, parameters)
        ...
        return doc, svg_arr, element_arr, label_data
...
def main():
    ...
    for i in range(100):
        ...
        doc, svg_arr, element_arr, element_data = SVGGEN.gen_svg()
        ...
        with open(os.path.join(trg_label_dir, str(i)), 'w+') as f:
